    ...
    return (
        <div className="flex xl:flex-row lg:flex-row md:flex-col">
            <div className="xl:w-1/2 lg:w-1/2 md:w-1/2 sm:w-1/2 xsm:w-8/12 lg:mx-auto md:mx-auto sm:mx-auto xsm:mx-auto path-div">
                ...
                <h1 className='font-[700] pt-[20px] xl:pl-[83px] lg:pl-[40px] xsm:pl-[20px] xl:text-[50px] lg:text-[50px] ms:text-[50px] sm:text-[30px] xsm:text-[30px] text-[#000024] opacity-70'>Welcome Back!</h1>
                <p className='xl:text-[25px] lg:text-[25px] xsm:pl-[20px] ms:text-[25px] sm:text-[15px] text-[#374550] xl:pl-[83px] lg:pl-[40px]'>Please Login to your account.</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <span onClick={(e) => {
                        e.preventDefault()
                    }} className="underline pt-[11px] xl:pl-[440px] lg:pl-[360px] md:pl-[250px] sm:pl-[190px] xsm:pl-[120px]"><Link to="/ForgetPasswordEA">Forgot Password?</Link></span>
                    <div className="xl:pl-[83px] lg:pl-[40px] pt-[41px] pb-[34px]">
                       <Link to="/Dashboard"> <button type='submit' className='rounded-[20px] text-white bg-[#000024] xl:w-[507px] h-[61px] lg:w-[470px] md:w-[420px] sm:w-[380px] xsm:w-[280px]'>Login</button> </Link>
                    </div>
                </form>
